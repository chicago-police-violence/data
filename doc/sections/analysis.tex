...
In this section, we provide exploratory visualizations and summaries of the
different entities present in the cleaned and linked data in the \url{final/}
folder in the repository. Code to reproduce these figures is
available in the \url{examples/} folder of the repository. 

\paragraph{Roster.}
Note that ``race'' and ``gender'' are binned per the CPD's coarse categories.
