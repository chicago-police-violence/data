...
In this section, we provide exploratory visualizations and summaries of the different entities 
present in the data. Code to reproduce these figures is available in the `examples/` folder of the repository.
