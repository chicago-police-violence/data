...
\textbf{Data Set:} may be found in the \texttt{final/} directory after running \texttt{make} and is available for download as ZIP file at \url{https://github.com/chicago-police-violence/data/releases/download/v0.1-pre/cpd-dataset-v0.1-pre.zip}.
